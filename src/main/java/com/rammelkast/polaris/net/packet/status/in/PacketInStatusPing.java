...
import com.rammelkast.polaris.net.packet.status.out.PacketOutStatusPing;

import lombok.Getter;

@Getter
public final class PacketInStatusPing extends Packet {
	...
	public void read(final PacketWrapper wrapper) {
		this.payload = wrapper.getBuffer().readLong();
	}
	...
	public void onReceive(final NetClient client) {
		client.sendPacket(new PacketOutStatusPing(this.payload));
	}
